package chat.infrastructure.repository;

import chat.domain.user.model.*;
import chat.domain.user.repository.IUserRepository;
import static chat.infrastructure.common.Constants.TalkType.Friend;
import static chat.infrastructure.common.Constants.TalkType.Group;
import chat.infrastructure.dao.*;
import chat.infrastructure.po.*;
